...
if (sc.understanding) {
  ...
  console.log(
    "\nIntent (first 200 chars):",
    sc.understanding.intent?.substring(0, 200) + "...",
  );
    ...
    for (const criterion of g.successcriteria) {
      if (criterion.num === "1.4.3") {
        ...
        if (criterion.understanding) {
          ...
          console.log(
            "Intent length:",
            criterion.understanding.intent?.length || 0,
          );
          console.log(
            "Benefits:",
            criterion.understanding.benefits?.length || 0,
          );
          console.log(
            "Resources:",
            criterion.understanding.resources?.length || 0,
          );
        }
      }
    }
